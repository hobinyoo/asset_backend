...
class DailyReportControllerTest extends BaseControllerTest {
    ...
    class GenerateReport {
        ...
        void success() throws Exception {
            Asset assetA = assetRepository.save(TestFixture.createLinkedAsset(userA));
        ...
        void returnsExistingReport() throws Exception {
            DailyReport existing = dailyReportRepository.save(
                    DailyReport.create(LocalDate.now(), "<p>기존 리포트</p>", "요약", userA));
    ...
    class GetAllReports {
        ...
        void success() throws Exception {
            dailyReportRepository.save(DailyReport.create(LocalDate.now(), "<p>A 리포트</p>", "A 요약", userA));
            dailyReportRepository.save(DailyReport.create(LocalDate.now().minusDays(1), "<p>B 리포트</p>", "B 요약", userB));
    ...
    class GetReportByDate {
        ...
        void success() throws Exception {
            ...
            dailyReportRepository.save(DailyReport.create(today, "<p>리포트</p>", "요약", userA));
