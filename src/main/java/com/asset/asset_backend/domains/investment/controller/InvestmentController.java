...
public class InvestmentController {
    ...
    public ResponseEntity<ApiResult<InvestmentResponse>> createInvestment(
        ...
        InvestmentResponse response = investmentService.createInvestment(request, userId);
    ...
    public ResponseEntity<ApiResult<ApiPageResponse<InvestmentResponse>>> getInvestments(
        ...
        Page<InvestmentResponse> investmentPage = investmentService.searchInvestments(owner, category, assetId, userId, pageable);
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ApiResult<InvestmentResponse>> getInvestmentById(
            @AuthenticationPrincipal Long userId,
            @PathVariable Long id) {
        return ResponseEntity.ok(ApiResult.success(investmentService.getInvestmentById(id, userId), "투자 항목을 조회했습니다."));
    }
    ...
    public ResponseEntity<ApiResult<List<InvestmentResponse>>> getInvestmentsByAssetId(
        ...
        return ResponseEntity.ok(ApiResult.success(investmentService.getInvestmentsByAssetId(assetId, userId), "자산 연결 투자 목록을 조회했습니다."));
    }
    ...
    public ResponseEntity<ApiResult<InvestmentResponse>> updateInvestment(
        ...
        return ResponseEntity.ok(ApiResult.success(investmentService.updateInvestment(id, request, userId), "투자 항목이 수정되었습니다."));
    }

    @DeleteMapping("/{id}")
    public ResponseEntity<ApiResult<Void>> deleteInvestment(
            @AuthenticationPrincipal Long userId,
            @PathVariable Long id) {
